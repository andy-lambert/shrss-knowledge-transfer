...
Identify the questions in the spreadsheet that are likely to have been generated by AI (ChatGPT, Microsoft Copilot, Claude, Perplexity, etc.). For those that qualify as potentially AI-generated:
...
To inform answers, for each question, as applicable:
