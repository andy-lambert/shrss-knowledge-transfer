- # SHRSS Author Tagging & Metadata Quick Guide
  ...
  *Goal: Make it fast and safe to upload, tag, and maintain assets.*
  ...
  | Training/Sandbox  | `/content/dam/shrss/training`  | `/content/dam/shrss/training/images`                  |
  ...
  **Don’t**
  ...
  - Don’t upload real production assets under `/training`.
  ...
  **Reminder**
  ...
  - **Don’t**
    - Don’t store real production assets under `/training`.
